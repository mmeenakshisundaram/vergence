...
probe.setName("IMS_UpdateAccidentInformation");
probe.setJavascript("var pdf = new FortegraUtil();res=pdf.updateAccidentInformation();");
var jsonContent = {};
jsonContent["AccidentInformationId"] = parseInt(inputs.AccidentInformationId);
