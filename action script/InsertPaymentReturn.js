/*
Action name: Util-JDBC-InsertPaymentReturn
Application: Global
*/

var probe = new JavascriptProbe(inputs.MidServerName);
probe.setName("IMS_InsertPaymentReturn");
probe.setJavascript("var pdf = new FortegraUtil();res=pdf.insertPaymentReturn();");
var jsonContent = {};
...
jsonContent["PaymentReturnResPayId"] = parseInt(inputs.PaymentReturnResPayId);
jsonContent["RecoveryCheckNum"] = inputs.RecoveryCheckNum;
